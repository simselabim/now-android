# NOW Android Mobile Architecture

## App State Routing

The root navigation graph should be state-driven:
...
The Android client should depend on the same backend contract as iOS:
